        ...
        if (mysqli_num_rows($sl_res)>0) {
                while ($row = mysqli_fetch_assoc($sl_res)) {
                    ...
                    <tr>
                        ...
                        <td><a href="index.php?delete_cat=<?php echo $category_id; ?>"   ><button class="bg-black  text-white mx-2 px-4  py-2 border-0 rounded mt-1">Remove </button></a> 
                    </td>
                    </tr>
            <?php
                }    
